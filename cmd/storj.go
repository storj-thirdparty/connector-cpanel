...
func UploadData(project *uplink.Project, configStorj ConfigStorj, uploadFileName string, fileHandle *os.File) {
	...
	_, err = io.Copy(upload, fileHandle)
	if err != nil {
